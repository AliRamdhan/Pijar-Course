const MentorCard = () => {
  ...
  return (
    <ul className="h-[70vh] flex flex-col justify-center items-center overflow-y-auto overflow-hidden">
      {mentors.map((mentor, key) => (
        <li key={key} className={`mb-10 ml-6 ${key === 0 ? "mt-[80vh]" : ""}`}>
          <span className="flex relative items-center justify-center w-7 h-7 bg-blue-100 rounded-full ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
            <img
