...
const ReasonCard = () => {
  return (
    <>
      <Card
        imgSrc="/assets/sustainable.jpg"
        className="2xl:w-96 xl:w-80 lg:w-96 md:w-96 sm:w-96 w-96 es:w-full sm:h-[460px] es:h-auto border-0"
      >
      ...
      >
        ...
        <p className="es:text-sm font-normal text-gray-700 dark:text-gray-400">
          ...
          <span className="customUnderline3">Pijar Pelajar?</span> agar dapat
          menempu dunia industri secepat-cepatnya.
        </p>
      </Card>
      <Card
        imgSrc="/assets/seekingJob.jpg"
        className="2xl:w-96 xl:w-80 lg:w-96 md:w-96 sm:w-96 w-96 es:w-full sm:h-[460px] es:h-auto border-0"
      >
        <h5 className="sm:text-2xl es:text-lg font-bold tracking-tight text-slate-700 dark:text-white">
        ...
        <p className="es:text-xs font-medium text-gray-400 flex justify-between">
