const User = require("../components/model/model.user"); // Import your User model
...
// Middleware to check if a user is a mentor user
...
module.exports = { isAdmin, isUser, isMentor };
